# 🖥️ Atividade: Internet e Programação Web – Avaliação Crítica e Melhorias Visuais no Projeto (Web 2.0)
...
### 1. 🎨 Revisão da Paleta de Cores

Reflita sobre as cores utilizadas em seu site.  
- Elas comunicam bem a proposta da marca?  
- Com base na **Teoria das Cores**, identifique se a paleta está alinhada com a identidade do projeto.
...
Avalie o visual geral do site: fundo, textos, menu, seções e rodapé.
...
Pense em como seu site se comporta em dispositivos menores (celulares, tablets).
...
- ✅ Repositório no GitHub com os arquivos atualizados do site
- ✅ Site publicado via **GitHub Pages**
- ✅ Arquivo `justificativa.md` (ou `README.md`) explicando:
...
1. Crie um repositório no GitHub com o nome do seu projeto (ex: `meu-site-web2`).
2. Envie os arquivos do seu site para o repositório:
   - `index.html`
   - `style.css`
   - Outras páginas ou imagens, se houver
3. No GitHub, vá em **Settings** (⚙️) do repositório.
4. No menu lateral, clique em **Pages**.
5. Em **Source**, selecione a branch principal (geralmente `main`) e clique em **Save**.
